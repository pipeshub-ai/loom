...
to guide alignment between the `workflow-builder` pip package and PipesHub's
...
| Concept | pip package (`workflow-builder`) | PipesHub |
|---------|--------------------------------|----------|
...
PipesHub should import `workflow-builder` as a dependency and:
