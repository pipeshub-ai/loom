...
calls the way :mod:`workflow_builder.connectors.credentials` reads
``LOOM_CREDENTIAL_KEY`` is that :func:`~workflow_builder.identity.verifier.build_verifier`
...
class IdentitySettings(BaseSettings):
    ...
    :func:`~workflow_builder.identity.verifier.build_verifier` if more than
