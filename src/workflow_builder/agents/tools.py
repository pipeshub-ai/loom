...
from workflow_builder.core.exceptions import ConfigurationError, ModelRetry
...
class Tool:
    ...
    def schema(self) -> dict[str, Any]:
        from workflow_builder.agents.models import ToolSchema
...
def coerce_tool(candidate: Any) -> Tool:
    ...
    from workflow_builder.runtime.workflow import WorkflowDefinition as _Workflow
    from workflow_builder.steps.definition import StepDefinition as _Step
