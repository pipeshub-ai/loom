...
They share :mod:`workflow_builder.toolsets.google.auth` because they
...
from workflow_builder.toolsets.google.auth import (
    GoogleAuth,
    GoogleCredentials,
    get_default_auth,
)
from workflow_builder.toolsets.google.calendar import GOOGLE_CALENDAR_MANIFEST
...
from workflow_builder.toolsets.google.gmail import GMAIL_MANIFEST
