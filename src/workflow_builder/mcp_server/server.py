...
def build_server(
    ...
    *,
    ...
    _register_tools(server, facade)
    _register_resources(server, facade)
    _register_prompts(server, facade)
    return server
...
def _register_tools(server: FastMCP, facade: RuntimeFacade) -> None:
    ...
    async def list_workflows() -> str:
        ...
        return await tools.list_workflows(facade)
    ...
    async def run_workflow(
        ...
        return await tools.run_workflow(
            facade, workflow, input_json, idempotency_key=idempotency_key
        )
    ...
    async def get_run_status(run_id: str) -> str:
        ...
        """
        return await tools.get_run_status(facade, run_id)
    ...
    async def list_runs(
        ...
        """
        return await tools.list_runs(facade, workflow, status, limit)

    @server.tool()
    async def get_run_journal(run_id: str) -> str:
        ...
        Args:
            run_id: The run identifier.
        """
        return await tools.get_run_journal(facade, run_id)
    ...
    async def approve_run(run_id: str, subject: str, approved: bool = True) -> str:
        ...
        """
        return await tools.approve_run(facade, run_id, subject, approved)
    ...
    async def send_event(run_id: str, event: str, payload_json: str = "null") -> str:
        ...
        """
        return await tools.send_event(facade, run_id, event, payload_json)
    ...
    async def cancel_run(run_id: str) -> str:
        ...
        Args:
            run_id: The run identifier.
        """
        return await tools.cancel_run(facade, run_id)
    ...
    async def retry_run(run_id: str) -> str:
        ...
        Args:
            run_id: The run identifier.
        """
        return await tools.retry_run(facade, run_id)
    ...
    async def replay_run(run_id: str) -> str:
        ...
        Args:
            run_id: The run identifier.
        """
        return await tools.replay_run(facade, run_id)
...
def _register_resources(server: FastMCP, facade: RuntimeFacade) -> None:
...
def _register_prompts(server: FastMCP, facade: RuntimeFacade) -> None:
