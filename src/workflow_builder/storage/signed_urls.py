...
:class:`~workflow_builder.storage.artifact.ArtifactVersion`. Downloads are
...
from workflow_builder.storage.blob import BlobNotFoundError, BlobService
...
class SignedUrlService:
    ...
    an :class:`~workflow_builder.storage.artifact.ArtifactService` to manage
