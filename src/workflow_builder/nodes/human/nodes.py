...
from workflow_builder.core.exceptions import ApprovalRejected
from workflow_builder.nodes.base import Node, NodeContext
from workflow_builder.nodes.errors import HumanRequestExpired
from workflow_builder.nodes.human.asking import TimeoutPolicy, ask
from workflow_builder.nodes.registry import register_node
from workflow_builder.nodes.spec import (
    EffectClass,
    NodeCategory,
    NodeDuration,
    NodeExample,
...
def human_spec(**declared: Any) -> NodeSpec:
    ...
    """
    return NodeSpec(
        import_module="workflow_builder.nodes.human",
