...
a verdict *does* lives in :mod:`workflow_builder.nodes.guard.runner`, so a guard
...
from workflow_builder.nodes.guard.runner import GuardVerdict
...
def guard_spec(**declared: Any) -> NodeSpec:
    ...
    return NodeSpec(
        import_module="workflow_builder.nodes.guard",
