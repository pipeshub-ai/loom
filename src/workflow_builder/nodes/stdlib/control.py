...
from workflow_builder.core.types import to_seconds
from workflow_builder.nodes.base import Node, NodeContext
from workflow_builder.nodes.registry import register_node
from workflow_builder.nodes.spec import NodeCategory, NodeDuration, NodeExample, NodeSpec
...
def control_spec(**declared: Any) -> NodeSpec:
    ...
    return NodeSpec(
        import_module="workflow_builder.nodes.stdlib.control",
