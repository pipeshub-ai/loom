...
from workflow_builder.core.ids import stable_hash
...
class NodeSpec(BaseModel):
    ...
    differs — ``workflow_builder.nodes.human`` rather than
    ``workflow_builder.nodes.human.nodes`` — because the import line is copied
