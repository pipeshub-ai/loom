...
3. **Around agent tool calls** — where they already ran, unchanged.
    ...
    from loom.nodes.guard import GuardVerdict
...
from loom.agents.guardrails import Guardrail, GuardrailAction, guardrail
from loom.nodes.guard.nodes import (
    BudgetGuard,
    BudgetIn,
    ContentGuard,
    ContentIn,
...
from loom.nodes.guard.runner import (
    GuardInput,
    GuardVerdict,
    apply_guards,
    as_verdict,
